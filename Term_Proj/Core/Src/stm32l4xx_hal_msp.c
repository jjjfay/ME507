...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC0     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(MYO1_GPIO_Port, MYO1_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC1     ------> ADC2_IN2
    */
    HAL_GPIO_DeInit(MYO2_GPIO_Port, MYO2_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC3     ------> ADC3_IN4
    */
    HAL_GPIO_DeInit(GPIOC, PRS_Pin|V_BAT_Pin);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    PA10     ------> TIM1_CH3
    */
    GPIO_InitStruct.Pin = RADIO_Pin|HAND_ENC_Pin;
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PC6     ------> TIM3_CH1
    */
    GPIO_InitStruct.Pin = MOTOR_ENC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA10     ------> TIM1_CH3
    */
    HAL_GPIO_DeInit(GPIOA, RADIO_Pin|HAND_ENC_Pin);
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PC6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(MOTOR_ENC_GPIO_Port, MOTOR_ENC_Pin);
