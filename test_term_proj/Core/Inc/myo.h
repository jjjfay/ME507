...
/**
 * @brief Represents a myoelectric sensor object that has an ADC and a value.
 */
struct{

	    ADC_HandleTypeDef* hal_adc; /**< The ADC object. */
	    int16_t prev_value; /**< The previously read ADC value. */
...
/**
 * @brief A function to calculate the set point.
 *
 * @param p_myo The myoelectric sensor object to perform the function on.
 */
//uint16_t get_setpoint(myo_t* p_myo);
