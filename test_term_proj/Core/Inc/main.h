...
#define HPWMB_Pin GPIO_PIN_1
#define HPWMB_GPIO_Port GPIOA
#define HPWMA_Pin GPIO_PIN_5
#define HPWMA_GPIO_Port GPIOA
#define SPINPWMA_Pin GPIO_PIN_10
#define SPINPWMA_GPIO_Port GPIOB
#define SPINPWMB_Pin GPIO_PIN_11
#define SPINPWMB_GPIO_Port GPIOB
